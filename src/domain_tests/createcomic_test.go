...
func TestCreateComic(t *testing.T) {
	...
	comics.AddComic(id, "Prophet", "Prophet 31", []string{"0.jpg", "1.jpg", "2.jpg", "3.jpg"}, []string{"\\source\\path\\to\\0.jpg", "\\source\\path\\to\\1.jpg", "\\source\\path\\to\\2.jpg", "\\source\\path\\to\\3.jpg"})
...
func TestCreateMultipleComics(t *testing.T) {
	...
	comics.AddComic(id1, "Prophet", "Prophet 31", []string{"0.jpg", "1.jpg", "2.jpg"}, []string{"\\source\\path\\to\\0.jpg", "\\source\\path\\to\\1.jpg", "\\source\\path\\to\\2.jpg"})
	comics.AddComic(id2, "Batman", "Batman 1", []string{"0.jpg"}, []string{"\\source\\path\\to\\0.jpg"})
